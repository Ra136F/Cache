...
const long long DISK_SIZE = 998323; // disk_capacity=DISK_SIZE*CHUNK_SIZE
const long long CHUNK_NUM = 998323;

const char *TRACE_PATH = "../trace/zipfian/10w_82_4k/tracea_runr-1w.txt";
...
const char *DISK_PATH = "/SMR/db/storage/diskr-1w.bin";
