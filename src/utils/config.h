...
const long long DISK_SIZE = 667212; // disk_capacity=DISK_SIZE*CHUNK_SIZE
const long long CHUNK_NUM = 667212;

const char *TRACE_PATH = "../trace/zipfian/100w_28_4k/tracea_runr.txt";
...
const char *DISK_PATH = "/SMR/db/storage/diskr-10.bin";
