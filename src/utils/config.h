...
const long long DISK_SIZE = 83757; // disk_capacity=DISK_SIZE*CHUNK_SIZE
const long long CHUNK_NUM = 83757;

const char *TRACE_PATH = "../trace/zipfian/30w_4k/tracea_run28.txt";
...
const char *DISK_PATH = "/SMR/db/storage/disk28-3.bin";
