...
const long long DISK_SIZE = 1000000; // disk_capacity=DISK_SIZE*CHUNK_SIZE
const long long CHUNK_NUM = 1000000;

const char *TRACE_PATH = "../trace/zipfian/10w_82_4k/tracea_run1.txt";
const char *CACHE_PATH = "/data2/Cache/cache_0.1.bin";
const char *CACHE_PATH_W = "/data2/Cache/cache_0.2.bin";
const long long CACHE_SIZE = CHUNK_NUM * 0.12;
